...
%yt_exe% -f "bestvideo[ext=mp4][height=1080][fps<=50]+bestaudio[ext=m4a]/bestvideo[ext=mp4][height=1080][fps=60]+bestaudio[ext=m4a]/bestvideo[ext=mp4][height<=1080][fps<=50]+bestaudio[ext=m4a]/best[ext=mp4]" --merge-output-format mp4 --limit-rate 300K --config-location youtube-dl_videos.cnf 1>youtube-dl_stdout.txt 2>youtube-dl_stderr.txt
